const API_SERVER_GET_POST = 'http://localhost/public_html/api_get_post.php';
const API_SERVER_DELETE = 'http://localhost/public_html/api_delete.php';
const API_SERVER_PUT = 'http://localhost/public_html/api_put.php';
